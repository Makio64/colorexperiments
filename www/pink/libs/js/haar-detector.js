 ...
 ** 
 ** Adapted by julesanchez (https://github.com/julesanchez) to work without canvas
 **
 **************************************************************************************/
(function() {
  var root = this;
  ...
  HAAR.Detector.prototype.detect = function(imagedata, baseScale, scale_inc, increment, min_neighbors, doCannyPruning) {
  ...
  HAAR.Detector.prototype.computeGray = function(imagedata) {
    this.gray = [];
    this.img = [];
    this.squares = [];
    var data = imagedata;
